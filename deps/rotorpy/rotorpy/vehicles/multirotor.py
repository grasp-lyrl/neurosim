...
class Multirotor(object):
    ...
    def __init__(self, quad_params, initial_state = {'x': np.array([0,0,0]),
        ...
        self.integration_method_rk45 = (integration_method == 'RK45')
    ...
    def step(self, state, control, t_step):
        ...
        if self.integration_method_rk45:
            # Option 1 - RK45 integration
            s = scipy.integrate.solve_ivp(s_dot_fn, (0, t_step), s, first_step=t_step)['y'][:,-1]
        else:
