...
from neurosim.utils.evsim.cu_rpg_vid2e_esim.src.esim_torch import EventSimulator_torch
...
class EventSimulatorVID2E_ESIM:
    ...
    def _init_with_image(self, image: torch.Tensor, time: int) -> None:
        ...
        print(f"[evsim-vid2e] Initialized event camera sim with sensor size: {image.shape}")
